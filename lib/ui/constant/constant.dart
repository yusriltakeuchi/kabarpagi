...
/// Constant Color
/// --------------
Color get primaryColor  => const Color(0xff16B074);
...
/// Device OS
/// ------------
String? get getDeviceOS => Platform.isAndroid ? "android" : Platform.isIOS ? "ios" : null;
...
bool isReallySmallPhoneHeight(BuildContext context) => MediaQuery.of(context).size.height < 600 ? true : false;
bool isBigPhoneHeight(BuildContext context) => MediaQuery.of(context).size.height > 1200 ? true : false;
